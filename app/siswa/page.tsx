                            ...
                            <table className="w-full text-left min-w-[4500px] border-collapse relative">
                                <thead className="bg-[#0f172a] text-gray-300 uppercase text-xs tracking-widest border-b border-slate-700 sticky top-0 z-30">
                                    <tr>
                                        ...
                                        <th className="p-5 text-center">NISM</th><th className="p-5 text-center">NISN</th><th className="p-5 text-center">NIK</th><th className="p-5 text-center">Tempat Lahir</th>
                                        <th className="p-5 text-center">Tgl Lahir</th><th className="p-5 text-center">Tingkat - Rombel</th><th className="p-5 text-center">Umur</th><th className="p-5 text-center">Status</th>
                                        <th className="p-5 text-center">L/P</th><th className="p-5 text-center">Alamat</th><th className="p-5 text-center">No Telepon</th><th className="p-5 text-center">Ayah Kandung</th>
                                        <th className="p-5 text-center">Ibu Kandung</th><th className="p-5 text-center">Nomor KK</th>
                                    ...
                                    {loading ? (
                                        ...
                                        .map((item, idx) => (
                                            <tr key={item.id} className="hover:bg-gray-700/30 transition-all text-sm whitespace-nowrap">
                                                ...
                                                <td className="p-5 text-center text-gray-600 sticky left-0 bg-gray-800 z-10 w-16">{idx + 1}</td>
                                                <td className="p-5 text-left font-bold sticky left-16 bg-gray-800/95 text-blue-400 border-r border-gray-700 shadow-lg z-10 w-[280px] min-w-[280px]">
                                                    {item.namaLengkap}
                                                </td>
                                                <td className="p-5 text-center text-gray-400">{item.nism}</td>
                                                ...
                                                <td className="p-5 text-center text-gray-400">{item.umur}</td>
                                                <td className="p-5 text-center">
                                                    <span className="text-green-500 font-bold">{item.status}</span>
                                                </td>
                                                <td className="p-5 text-center font-bold">{item.jenisKelamin}</td>
                                                <td className="p-5 text-center text-gray-400 max-w-xs truncate">{item.alamat}</td>
                                                <td className="p-5 text-center text-gray-400">{item.noTelepon}</td>
                                                <td className="p-5 text-center text-gray-400">{item.namaAyah}</td>
                                                <td className="p-5 text-center text-gray-400">{item.namaIbu}</td>
                                                <td className="p-5 text-center text-gray-400 font-mono">{item.nomorKK}</td>
                            ...
                            <div className="bg-[#0f172a] border border-slate-700 w-full max-w-6xl rounded-3xl p-8 shadow-2xl overflow-y-auto max-h-[95vh] relative animate-in fade-in zoom-in duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-[12px]">
                                    <div className="flex flex-col gap-2 col-span-1 md:col-span-2">
                                        ...
                                        <input name="namaLengkap" value={formData.namaLengkap || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl outline-none focus:ring-2 focus:ring-blue-500" />
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">NISM</label>
                                        <input name="nism" value={formData.nism || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">NISN</label>
                                        <input name="nisn" value={formData.nisn || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">Tingkat - Rombel</label>
                                        <input name="tingkatRombel" value={formData.tingkatRombel || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">Nomor KK</label>
                                        <input name="nomorKK" value={formData.nomorKK || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl font-mono" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">Nama Ayah</label>
                                        <input name="namaAyah" value={formData.namaAyah || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">No Telepon</label>
                                        <input name="noTelepon" value={formData.noTelepon || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>

                                    <div className="flex flex-col gap-2">
                                        <label className="block text-gray-500 uppercase font-black">Nama Ibu Kandung</label>
                                        <input name="namaIbu" value={formData.namaIbu || ""} onChange={handleInputChange} className="w-full bg-gray-900 border border-gray-700 p-3 rounded-xl" />
                                    </div>
